...
class wpdb {
	...
	/**
	 * Sets the database search path.
	 *
	 * @param resource $dbh     The resource given by mysql_connect
	 */
	function set_search_path( $dbh ) {
		if ( ! defined( DB_SEARCH_PATH ) )
			pg_query( $this->prepare('SET search_path TO %s', DB_SEARCH_PATH), $dbh );
	}
